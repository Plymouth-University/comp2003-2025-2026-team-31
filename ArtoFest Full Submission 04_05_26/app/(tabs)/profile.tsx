              ...
              <View style={[styles.optionCard, isWide ? styles.optionCardWide : null]}>
                ...
                <Link href="/admin" asChild>
                  <Pressable style={styles.adminButton}>
                    <Text style={styles.adminButtonText}>Admin Section</Text>
                  </Pressable>
                </Link>
        ...
        <View style={styles.page}>
          ...
          <View style={[styles.columns, isWide ? styles.columnsWide : null]}>
            <View style={[styles.optionCard, isWide ? styles.optionCardWide : null]}>
              ...
              <Text style={styles.optionText}>Already registered?</Text>
            ...
            <View style={[styles.optionCard, isWide ? styles.optionCardWide : null]}>
              ...
              <Text style={styles.optionText}>Create a new account?</Text>
